...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zeronecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zeronecointools.com", "84.52.62.25"},

    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"zeronecointools.com", "testnet-seed.zeronecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zeronecoin is probably already running."), addrBind.ToString().c_str());
        else
